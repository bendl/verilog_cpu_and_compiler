...
The low-middle range of FPGA devices I am targeting is the popular and affordable yet feature rich Spartan-6 and Artix-7 FPGAs. From my placement, I have gained experience in Xilinx FPGA and so will be targeting them for this project to reduce risk and development time.
...
\begin{table}[h]
	...
	\\ \hline
    \end{tabularx}
    \caption{Initial Project Plan time breakdown\\ *Expected time.\\Shaded rows are time varying periods for bug fixing.}
\end{table}
