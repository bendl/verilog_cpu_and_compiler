...
\end{minted}
\change{To much info, just give word in text.}
...
The \scname{} processor is \textbf{not} designed to run in high-reliability or safety-critical environments that require established safety standards, such as the UK Defence Standard 00-56 \citep{defstan_0056_2} and IEC 61508 \citep{iec61508}.\improvement{Cite actual standards documents, not papers describing them.}
