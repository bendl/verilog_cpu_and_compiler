...
\caption{The project's gantt time chart showing project stages, times, and deadlines.}
...
Debugging on live FPGA devices is difficult and so sufficient verification must be performed prior to deployment. This has gained me a lot of experience in troubleshooting FPGA designs in simulation and when implemented on the device.
...
The project required 2 complex systems that needed to interact with each other
